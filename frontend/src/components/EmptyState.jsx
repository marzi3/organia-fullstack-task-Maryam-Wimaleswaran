...
export default function EmptyState({ view, onCreateTask }) {
  ...
  const messages = {
    ...
    COMPLETED: { title: 'No completed tasks', desc: 'You haven\'t completed any tasks yet. Tick something off your list to see them here!', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">
        {msg?.title || (view && view !== 'tasks' && !isFilteredView ? `No tasks in ${view}` : 'Your workspace is clear')}
      </h3>
      <p className="text-gray-500 dark:text-gray-400 text-center max-w-sm mb-6">
        {msg?.desc || (view && view !== 'tasks' && !isFilteredView
